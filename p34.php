    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="input-group">
                ...
                <input type="number" step="0.01" name="cantidad" placeholder="Ej. 100" required>
            </div>
            <div class="input-group">
                <label>Tasa de cambio:</label>
                <input type="number" step="0.0001" name="tasa" placeholder="Ej. 0.85" required>
            </div>
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST"): ?>
            <div class="resultado">
                <?php 
                    ...
                    echo "El resultado es " . number_format($total, 2);
                ?>
            </div>
        <?php endif; ?>
    </div>
