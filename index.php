...
<head>
    ...
    <style>
        ...
        /* Estilo especial para la tarjeta final */
        .card-final { border-left-color: var(--uas-gold); background: #fdfbf7; }
        .badge-final { background: var(--uas-blue); color: white; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="grid">
        ...
        <a href="p26.php" class="card"><h3>P26</h3><p>Tablas de Multiplicar.</p><span class="badge">JS</span></a>
        ...
        <a href="practica_final.php" class="card card-final">
            <h3>FINAL</h3>
            <p>Sistema Integral: Bitácora + Login.</p>
            <span class="badge badge-final">PHP/MySQL/CSS</span>
        </a>
    </div>
</body>
</html>